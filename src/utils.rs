...
pub fn tokenize(input_path: PathBuf, max_dictionary_size: u128, output_path: Option<PathBuf>) {
...
pub fn encode(input_path: PathBuf, dictionary_path: PathBuf, output_path: Option<PathBuf>) {
...
pub fn decode(input_path: PathBuf, dictionary_path: PathBuf, output_path: Option<PathBuf>) {
    let dictionary = match fs::read_to_string(dictionary_path.clone()) {
        Ok(content) => content,
        Err(e) => {
            eprintln!(
